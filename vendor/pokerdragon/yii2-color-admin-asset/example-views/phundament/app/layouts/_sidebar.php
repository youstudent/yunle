...
foreach (\coloradmin\helpers\Metadata::getModules() as $name => $module) {
    $role                        = $name;
    ...
    switch (true) {
        case (!empty($moduleConfigItem)):
            ...
            $moduleConfigItem['visible'] = \coloradmin\helpers\RouteAccess::can($moduleConfigItem['url']);
...
echo coloradmin\widgets\Menu::widget([
