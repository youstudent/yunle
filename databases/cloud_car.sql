...
-- ----------------------------
BEGIN;
INSERT INTO `cdc_auth_assignment` VALUES ('代理商', '18', '1502502471'), ('代理商', '19', '1502502587'), ('代理商', '20', '1502502859'), ('代理商', '22', '1502503323'), ('代理商', '26', '1502503078'), ('代理商', '29', '1502503554'), ('代理商', '30', '1502530676'), ('客服', '2', '1502531072'), ('服务商', '1', '1502500794'), ('管理员', '1', '1502446690');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cdc_auth_item_child` VALUES ('代理商列表 - 获取所有代理商权限', '/abs-route/get-all-agency'), ('会员列表 - 获取所有会员', '/abs-route/get-all-member'), ('业务员列表 - 获取所有业务员', '/abs-route/get-all-salesman'), ('服务商列表 - 获取所有服务商权限', '/abs-route/get-all-service'), ('获取客户经理权限', '/abs-route/get-customer-manager'), ('权限分配', '/admin/assignment/*'), ('菜单管理', '/admin/menu/*'), ('权限管理', '/admin/permission/*'), ('角色管理', '/admin/role/*'), ('路由管理', '/admin/route/*'), ('用户管理', '/admin/user/*'), ('代理商列表', '/agency/index'), ('代理商账号信息', '/agency/profile'), ('代理商详情', '/agency/view'), ('驾照列表', '/driver/index'), ('身份证列表', '/identity/index'), ('添加保险商', '/insurance-company/create'), ('删除保险商', '/insurance-company/delete'), ('保险商列表', '/insurance-company/index'), ('编辑保险商', '/insurance-company/update'), ('编辑保险商', '/insurance-company/validate-form'), ('保险订单列表', '/insurance-order/index'), ('添加险种', '/insurance/create'), ('删除险种', '/insurance/delete'), ('险种列表', '/insurance/index'), ('会员添加', '/member/create'), ('变更会员业务员', '/member/modify-salesman'), ('会员实名信息查看', '/member/real'), ('会员编辑', '/member/update'), ('会员添加', '/member/validate-form'), ('会员编辑', '/member/validate-form'), ('会员详情', '/member/view'), ('发送通知', '/message/create'), ('删除通知', '/message/delete'), ('通知列表', '/message/index'), ('查看通知', '/message/view'), ('订单列表', '/order/index'), ('订单池查看', '/order/wall'), ('添加服务商', '/redactor/upload-img'), ('编辑服务商', '/redactor/upload-img'), ('添加服务商', '/redactor/upload-img-json'), ('编辑服务商', '/redactor/upload-img-json'), ('业务员添加', '/salesman/create'), ('业务员列表', '/salesman/index'), ('业务员编辑', '/salesman/update'), ('业务员编辑', '/salesman/validate-form'), ('查看业务员', '/salesman/view'), ('添加服务商', '/service/create'), ('服务商列表', '/service/index'), ('服务商账号信息', '/service/profile'), ('编辑服务商', '/service/update'), ('添加服务商', '/service/validate-form'), ('编辑服务商', '/service/validate-form'), ('服务商详情', '/service/view'), ('系统设置', '/system/index'), ('保单列表', '/warranty/index'), ('代理商', '业务员列表'), ('管理员', '业务员列表'), ('代理商', '业务员添加'), ('管理员', '业务员添加'), ('代理商', '业务员编辑'), ('管理员', '业务员编辑'), ('代理商', '业务员详情'), ('管理员', '业务员详情'), ('管理员', '代理商列表'), ('管理员', '代理商详情'), ('管理员', '代理商账号信息'), ('管理员', '会员实名信息查看'), ('代理商', '会员添加'), ('管理员', '会员添加'), ('代理商', '会员编辑'), ('管理员', '会员编辑'), ('代理商', '会员详情'), ('管理员', '会员详情'), ('管理员', '保单列表'), ('管理员', '保险商列表'), ('代理商', '保险订单列表'), ('管理员', '保险订单列表'), ('管理员', '删除保险商'), ('管理员', '删除通知'), ('管理员', '删除险种'), ('代理商', '发送通知'), ('管理员', '发送通知'), ('管理员', '变更会员业务员'), ('管理员', '我的信息'), ('管理员', '服务商列表'), ('管理员', '服务商详情'), ('管理员', '服务商账号信息'), ('代理商', '权限分配'), ('管理员', '权限分配'), ('代理商', '权限管理'), ('管理员', '权限管理'), ('管理员', '查看业务员'), ('管理员', '查看通知'), ('管理员', '添加保险商'), ('管理员', '添加服务商'), ('管理员', '添加险种'), ('代理商', '用户管理'), ('管理员', '用户管理'), ('管理员', '系统设置'), ('管理员', '编辑保险商'), ('管理员', '编辑服务商'), ('管理员', '菜单管理'), ('代理商', '角色管理'), ('管理员', '角色管理'), ('管理员', '订单列表'), ('管理员', '订单池查看'), ('管理员', '路由管理'), ('管理员', '身份证列表'), ('管理员', '通知列表'), ('管理员', '险种列表'), ('管理员', '驾照列表');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cdc_service_user` VALUES ('1', '2', '1', '1'), ('2', '24', '30', '0');
COMMIT;
