        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <form action="<?= Url::to(["insurance-company/update",'id'=> $model->id]) ?>" method="POST" data-parsley-validate="true"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group block1">
                                                <label>保险公司名</label>
                                                <input type="text" name="InsuranceCompany[name]" placeholder="保险公司名" value="<?=$model->name?>"
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:;" class="btn btn-sm btn-danger ajax-post"
                   data-url="<?= Url::to(["insurance-company/update"]) ?>" data-id="modal-alert-confirm"
