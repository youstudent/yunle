            ...
            <table id="data-table" class="table table-striped table-bordered">
                ...
                <?php foreach($dataProvider->getModels() as $index => $model): ?>
                    <tr class="">
                        ...
                        <td align="center">
                            <div class="btn-group">
                                <a href="<?= Url::to(['driver-detail', 'id'=> $model->id]) ?>" data-toggle="modal" data-backdrop="static" data-target="#_pd_modal"><span class="btn btn-info m-r-1 m-b-5 btn-xs"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-form"></svg> 驾驶证详情</span></a>
                                <?php if ($model->status == 0) {?>
                                    ...
                                    <a href="<?= Url::to(['driver-out', 'id'=> $model->id]) ?>" data-toggle="modal" data-backdrop="static" data-target="#_pd_modal"><span class="btn btn-info m-r-1 m-b-5 btn-xs"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-bianji1"></svg> 不通过</span></a>
                                <?php } ?>
                            </div>
                        </td>
                    </tr>
