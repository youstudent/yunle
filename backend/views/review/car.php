        ...
        <div class="panel-body">
            ...
            <form class="form-inline"  action="" method="GET">
                <div class="form-group m-r-10">
                    <input type="text" class="form-control" name="Car[name]" id="name" value="<?= $searchModel->name ?>" placeholder="发起人">
                </div>
                <div class="form-group m-r-10">
                    <input type="text" class="form-control" name="Car[phone]" id="phone" value="<?= $searchModel->phone ?>" placeholder="发起人联系方式">
                </div>
                <div class="form-group m-r-10">
                    <select class="form-control" name="Car[status]" id="Car" style="min-width: 105%;">
