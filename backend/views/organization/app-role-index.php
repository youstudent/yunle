            ...
            <table id="data-table" class="table table-striped table-bordered">
                ...
                <?php foreach($dataProvider->getModels() as $index => $model): ?>
                    <tr class="">
                        ...
                        <td align="center">
                            <div class="btn-group">
                                <a href="<?= Url::to(['app-role-assign', 'id'=> $model->id]) ?>"><span class="btn btn-warning m-r-1 m-b-5 btn-xs">权限</span></a>
                                <a href="<?= Url::to(['app-role-update', 'id'=> $model->id]) ?>" data-toggle="modal" data-target="#_pd_modal" data-backdrop="static"><span class="btn btn-warning m-r-1 m-b-5 btn-xs">编辑</span></a>
