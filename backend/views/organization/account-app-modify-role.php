...
<div class="modal-body">
    ...
    <?php $service_id = \common\components\Helper::byAdminIdGetServiceId(Yii::$app->user->identity->id); ?>
    <?= $form->field($model, 'role_id')->dropDownList(
        \backend\models\AppRole::find()->where(['service_id'=> $service_id])->select('name,id')->indexBy('id')->column()
    ) ?>
