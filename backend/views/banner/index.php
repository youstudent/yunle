...
<!--                        </td>-->
                        ...
                        <td align="center">
                            <div class="btn-group">
                                ...
                                <a href="<?= Url::to(['delete', 'id'=> $model->id]) ?>" data-confirm="确认删除此项吗!" data-method="post" data-pjax="0"><span class="btn btn-danger m-r-1 m-b-5 btn-xs"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-close"></use></svg> 删除</span></a>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
